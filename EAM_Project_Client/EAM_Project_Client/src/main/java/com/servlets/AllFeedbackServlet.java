...
@WebServlet(name = "AllFeedbackServlet", urlPatterns = {"/manageFeedback"})
public class AllFeedbackServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listFeedback = port.getFeedback();
        request.setAttribute("listFeedback", listFeedback);
        HttpSession session = request.getSession(false);
        request.setAttribute("username", session.getAttribute("username"));
        RequestDispatcher dispatcher = request.getRequestDispatcher("ListFeedback.jsp");
